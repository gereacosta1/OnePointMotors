        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#39FF14] text-[#0B0F10] text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center animate-pulse">
                  {totalItems}
                </span>
              )}
            </Button>
            ...
            >
              {isOpen ? (
                <X className="w-5 h-5 text-[#0B0F10]" />
              ) : (
                <Menu className="w-5 h-5 text-[#0B0F10]" />
              )}
            </Button>
          </div>
        </div>
